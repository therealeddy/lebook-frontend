...
export default function Book(props) {
  ...
  const style = {
    photoBook: {
      backgroundImage: `url('${urlCloud}/${book.keyImage}')`
    },
    close: {
      ...
      {modal && (
        <div className="modal-book">
          <div className="modal-b-body d-flex">
            <span style={style.close} onClick={handleModalOff} />
            <div className="image-book" style={style.photoBook} />
            <div className="infos">
              <div className="top">
                <h2>{book.name}</h2>
              ...
              <div className="bottom">
                <a
                  href={`${urlCloud}/${book.keyDocument}`}
                  target="_blank"
